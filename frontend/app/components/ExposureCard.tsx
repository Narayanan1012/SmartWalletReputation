...
function ExposureCard({ exposure, onViewEvidence }: ExposureCardProps) {
  ...
  return (
    <div
      className={`relative rounded-lg ${config.bg} border ${config.border} ${config.hoverBorder} overflow-hidden transition-colors duration-150`}
    >
      {/* Left accent bar — flat solid */}
      ...
      <div className="pl-5 pr-4 py-4">
        ...
        <div className="flex items-center justify-between mb-4">
          <span
            className={`inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md text-xs font-semibold border ${config.badge}`}
          >
        ...
        <div className="space-y-2.5 mb-4">
          {exposure.token && (
            <div className="flex items-center gap-2">
              <div
                className={`w-8 h-8 rounded-md ${config.bg} border ${config.border} flex items-center justify-center flex-shrink-0`}
              >
        ...
        {/* Reason */}
        <div className="rounded-md bg-neutral-900 border border-neutral-800 px-3 py-2.5 mb-4">
        ...
        <button
          ...
          className={`w-full inline-flex items-center justify-center gap-2 px-4 py-2 rounded-md ${config.bg} border ${config.border} ${config.hoverBorder} text-xs font-medium transition-colors duration-150 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500`}
        >
          <svg className={`w-3.5 h-3.5 ${config.icon}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
